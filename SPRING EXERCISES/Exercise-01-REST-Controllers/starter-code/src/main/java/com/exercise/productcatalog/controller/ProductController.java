...
public class ProductController {
    ...
    // there is only one constructor. No annotation needed for single-constructor
    // injection!
    ...
    // - Return HTTP 200 OK
    // Hint: Use @GetMapping and add @RequestParam(required = false)
    ...
    // OR ResponseEntity.created(URI.create("/api/products/" +
    ...
    // - If the product exists: update all fields from `updated`, save, return 200
    // OK
