...
public class BookServiceImpl implements BookService {
    ...
    // TODO 5: Implement getBookById(Long id) — return Optional<Book> from
    // repository
    @Override
    ...
    // TODO 6: Implement getAvailableBooks() — return only books where isAvailable()
    // == true
    ...
    // - If !book.isAvailable(): throw new IllegalStateException("Book is already
    // checked out")
    ...
    // 2. If book.isAvailable(): throw new IllegalStateException("Book is not
    // checked out")
    ...
    // TODO 10: Implement removeBook(Long id) — delegate to
