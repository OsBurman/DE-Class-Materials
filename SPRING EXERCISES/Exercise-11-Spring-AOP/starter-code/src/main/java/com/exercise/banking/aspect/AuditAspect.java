...
public class AuditAspect {
    ...
    // TODO 9: Create an @Around advice that triggers on methods annotated with @Audited.
    //
    //         @Around("@annotation(audited)")
    //         public Object audit(ProceedingJoinPoint joinPoint, Audited audited) throws Throwable {
    //
    //         Note: "@annotation(audited)" binds the annotation instance to the parameter "audited"
    ...
    //         4. Log: "[AUDIT] Action=" + audited.action() + " Method=" + methodName + " completed successfully"
    //         5. return result;
    //
