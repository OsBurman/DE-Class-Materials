...
public class AuditAspect {
    ...
    public Object audit(ProceedingJoinPoint joinPoint, Audited audited) throws Throwable {
        ...
        try {
            ...
            log.info("[AUDIT] Action={} Method={} completed successfully", audited.action(), methodName);
            return result;
        } catch (Exception ex) {
            log.warn("[AUDIT] Action={} Method={} failed with: {}", audited.action(), methodName, ex.getMessage());
            throw ex;
        }
    }
}
