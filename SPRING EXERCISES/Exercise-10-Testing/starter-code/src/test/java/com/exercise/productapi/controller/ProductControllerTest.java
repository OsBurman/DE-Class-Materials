...
public class ProductControllerTest {
    ...
    //         @MockBean replaces the real ProductService in the Spring context with a Mockito mock.
    ...
    //          Stub: when(productService.getAllProducts()).thenReturn(List.of(sampleResponse))
    ...
    //          Stub: when(productService.getProductById(99L)).thenThrow(new ResourceNotFoundException("Product", 99L))
