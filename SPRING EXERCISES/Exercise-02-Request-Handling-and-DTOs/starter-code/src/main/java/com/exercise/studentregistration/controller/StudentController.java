...
public class StudentController {
    ...
    // In larger projects you'd use a library like MapStruct, but for now we do it
    // manually.
    ...
    private StudentSummaryResponse toSummary(Student student) {
        // Hint: Create a new StudentSummaryResponse, combine first+last name for
        // fullName
        return null; // replace this
    }
    ...
    // TODO 8: Add @GetMapping. Return a list of ALL students mapped to
    // StudentResponse.
    ...
    // Create a new Student from the request data, set enrolledAt =
    // LocalDateTime.now(),
    // set an initial gpa of 0.0, save it, and return StudentResponse with 201
    // Created.
    ...
    // TODO 13: Add @GetMapping("/{id}/summary"). Return StudentSummaryResponse or
    // 404.
