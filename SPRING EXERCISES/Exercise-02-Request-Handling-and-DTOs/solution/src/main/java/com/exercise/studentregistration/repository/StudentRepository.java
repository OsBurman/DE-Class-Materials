...
public class StudentRepository {
    ...
    public StudentRepository() {
        save(new Student(null, "Alice", "Johnson", "alice@uni.edu", "Computer Science", 3, 3.8,
                LocalDateTime.now().minusYears(2)));
        save(new Student(null, "Bob", "Smith", "bob@uni.edu", "Mathematics", 2, 3.2,
                LocalDateTime.now().minusYears(1)));
        save(new Student(null, "Carol", "Williams", "carol@uni.edu", "Physics", 4, 3.9,
                LocalDateTime.now().minusYears(3)));
        save(new Student(null, "David", "Brown", "david@uni.edu", "Computer Science", 1, 2.8,
