...
class CourseRepository {
    ...
    public void seed() {
        save(Course.builder()
                ...
                .department("Computer Science").credits(3).rating(4.8)
                .enrollmentLimit(30).currentEnrollment(28).build());
        save(Course.builder()
                .title("Data Structures & Algorithms").instructor("Dr. Johnson")
                .department("Computer Science").credits(4).rating(4.7)
                .enrollmentLimit(25).currentEnrollment(22).build());
        save(Course.builder()
                .title("Database Systems").instructor("Prof. Lee")
                .department("Data Engineering").credits(3).rating(4.5)
                .enrollmentLimit(35).currentEnrollment(30).build());
        save(Course.builder()
                .title("Big Data Processing").instructor("Dr. Williams")
                .department("Data Engineering").credits(4).rating(4.6)
                .enrollmentLimit(20).currentEnrollment(18).build());
        save(Course.builder()
                .title("Web Development").instructor("Prof. Davis")
                .department("Software Engineering").credits(3).rating(4.4)
                .enrollmentLimit(40).currentEnrollment(38).build());
        save(Course.builder()
                .title("Cloud Architecture").instructor("Dr. Brown")
                .department("Software Engineering").credits(3).rating(4.9)
                .enrollmentLimit(25).currentEnrollment(20).build());
    }
...
public class Application {
    ...
    public CommandLineRunner startupBanner() {
        return args -> {
            System.out.println("\n================================================");
            System.out.println("  Course Service (port 8082)");
            System.out.println("================================================");
            System.out.println("  Ready to serve course data to student-service");
            System.out.println("------------------------------------------------");
            ...
            System.out.println("  POST   http://localhost:8082/api/courses");
            System.out.println("  DELETE http://localhost:8082/api/courses/{id}");
            System.out.println("================================================\n");
        };
    }
}
