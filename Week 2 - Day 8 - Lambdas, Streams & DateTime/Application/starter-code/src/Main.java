...
public class Main {
    public static void main(String[] args) {
        ...
        // System.out.println("\n--- Average Salary ---");
        // dashboard.getAverageSalary(employees).ifPresent(avg -> System.out.printf("$%.2f%n", avg));

        // System.out.println("\n--- Grouped by Department ---");
        // dashboard.groupByDepartment(employees).forEach((dept, emps) -> { ... });

        // System.out.println("\n--- Highest Paid ---");
        // dashboard.findHighestPaid(employees).ifPresent(e -> System.out.println(e.name()));
        //     // orElse: dashboard.findHighestPaid(List.of()).orElse(new Employee(...))

        // System.out.println("\n--- Tenures ---");
        // employees.forEach(e -> System.out.println(e.name() + ": " + dashboard.getTenure(e)));

        // System.out.println("\n--- Formatted Hire Dates ---");
        // employees.forEach(e -> System.out.println(e.name() + ": " + dashboard.getFormattedHireDate(e)));
