...
public class Member {
    ...
    public int    getId()   { return 0;    } // TODO: return id
    public String getName() { return "";   } // TODO: return name

    // TODO 7: Implement borrowBook(Book b)
    //   - If borrowCount >= 3, print "Cannot borrow more than 3 books." and return false
    ...
    //   - If not found, print "Book not found in member's borrowed list." and return false
    ...
    public Book[] getBorrowed()    { return new Book[0]; } // TODO: return borrowed
    public int    getBorrowCount() { return 0;           } // TODO: return borrowCount
