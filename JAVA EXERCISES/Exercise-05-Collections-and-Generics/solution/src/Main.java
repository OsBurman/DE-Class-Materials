...
public class Main {
    ...
    static class Student implements Comparable<Student> {
        ...
        Student(int id, String name, String major) { this.id=id; this.name=name; this.major=major; }

        @Override public int compareTo(Student o) { return this.name.compareTo(o.name); }
        @Override public String toString() { return String.format("Student[%d] %s (%s)", id, name, major); }
    }
    ...
    static Set<String> getUniqueMajors(List<Student> students) {
        ...
        for (Student s : students) majors.add(s.major);
        return majors;
    }
