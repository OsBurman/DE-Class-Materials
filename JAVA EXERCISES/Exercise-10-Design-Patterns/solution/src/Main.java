...
public class Main {
    public static void main(String[] args) {
        ...
        EventListener security = (type, data) ->
            System.out.println("[EventBus] " + type + " received by SecurityListener: " + data);
        EventListener audit = (type, data) ->
            System.out.println("[EventBus] " + type + " received by AuditListener: " + data);
