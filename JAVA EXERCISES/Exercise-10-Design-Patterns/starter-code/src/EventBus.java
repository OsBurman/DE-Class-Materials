 ...
 * (create list if absent: listeners.computeIfAbsent(eventType, k -> new
 * ArrayList<>()))
 ...
 * SecurityListener — prints "[EventBus] <eventType> received by
 * SecurityListener: <data>"
 * AuditListener — prints "[EventBus] <eventType> received by AuditListener:
 * <data>"
