 ...
 *
 * TODO 1: Add protected fields: accountNumber (String), ownerName (String), balance (double),
 *         transactions (List<Transaction>) — initialize as new ArrayList<>()
 *
 * TODO 2: Constructor(String accountNumber, String ownerName, double initialBalance)
 *         Validate initialBalance >= 0, throw BankException.InvalidAmountException if not.
 ...
 *
 * TODO 6: protected void addTransaction(Transaction.Type type, double amount, String desc)
 *         Add new Transaction to transactions list.
 *
 * TODO 7: Getters: getAccountNumber(), getOwnerName(), getBalance(), getTransactions()
 *
...
public abstract class Account {
    ...
    // TODO 3
    public void deposit(double amount) throws BankException { /* TODO */ }
    ...
    // TODO 6
    protected void addTransaction(Transaction.Type type, double amount, String desc) { /* TODO */ }

    // TODO 7: getters
    public String            getAccountNumber() { return ""; }
    public String            getOwnerName()     { return ""; }
    public double            getBalance()       { return 0; }
    public List<Transaction> getTransactions()  { return new ArrayList<>(); }
