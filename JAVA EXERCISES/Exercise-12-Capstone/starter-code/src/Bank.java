 ...
 *
 * TODO 1: Make Bank a Singleton (private constructor, private static instance, getInstance()).
 *
 ...
 *         Generate account number: type.equals("savings") ? "SAV-" : "CHK-" + String.format("%03d", nextId++)
 *         Create SavingsAccount (rate=0.03) or CheckingAccount (overdraft=500) based on type.
 ...
 *
 * TODO 7: getAllTransactions() returns flat List<Transaction> from all accounts combined.
 *         Hint: use streams — accounts.values().stream().flatMap(a -> a.getTransactions().stream())
 */
public class Bank {
    ...
    // TODO 6
    public Collection<Account> getAllAccounts() { return new ArrayList<>(); /* TODO */ }

    // TODO 7
    public java.util.List<Transaction> getAllTransactions() { return new ArrayList<>(); /* TODO */ }
}
