...
public class Main {
    ...
    static class Employee {
        final int id; final String name; final String department;
        final double salary; final int yearsExperience; final List<String> skills;
        ...
        Employee(int id, String name, String dept, double salary, int yrs, String... skills) {
            ...
            this.salary = salary; this.yearsExperience = yrs;
            this.skills = List.of(skills);
        }
        String getName()  { return name; }
        String getDept()  { return department; }
        double getSalary(){ return salary; }
        int    getYrs()   { return yearsExperience; }
    ...
    //   Use: sorted(Comparator.comparingDouble(...).reversed()) → map → collect(Collectors.joining("\n"))
    // -----------------------------------------------------------------
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Highest paid: " + top.map(e -> e.name + " @ $" + String.format("%,.2f", e.salary)).orElse("None"));
        ...
        System.out.println("Above $75k threshold: " + parts.get(true).stream().map(Employee::getName).collect(Collectors.joining(", ")));
        System.out.println("Below $75k threshold: " + parts.get(false).stream().map(Employee::getName).collect(Collectors.joining(", ")));
