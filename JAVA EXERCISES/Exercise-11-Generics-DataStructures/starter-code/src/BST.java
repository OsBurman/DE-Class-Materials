 ...
 * TODO 5: Implement inOrder() — return sorted List<T> via recursive in-order
 * traversal.
...
public class BST<T extends Comparable<T>> {
    ...
    public List<T> inOrder() {
        ...
        /* TODO: inOrderRec(root, result); */ return result;
    }
