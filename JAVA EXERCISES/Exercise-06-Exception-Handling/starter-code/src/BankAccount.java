...
public class BankAccount {
    ...
    //   Throws: InvalidAmountException (unchecked), DailyLimitExceededException (checked),
    //           InsufficientFundsException (checked)
    //   Checks (in order):
    //     1. amount <= 0                        → InvalidAmountException
    //     2. withdrawnToday + amount > dailyLimit → DailyLimitExceededException(dailyLimit)
    ...
    public void resetDailyLimit() { withdrawnToday = 0.0; }
