...
| Spring Boot Hackerrank | Spring Boot | 120 min | [Link](https://www.hackerrank.com/work/tests/2110894) | Derived queries, soft delete, exception-to-HTTP mapping, spring testing, `PathVariable`, `RequestParam` |
...
| Hackathon Name | Topics | Link |
|----------------|--------|------|
| xxx xxxxx xxx | xxxx | [Link](#) |
| Full-Stack Hackathon | Java, Spring Boot, React, SQL | [Link](#) | -->
